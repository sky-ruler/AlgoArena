...
const { getProfileStats, getUserProfile } = require('../controllers/dashboard.controller');
...
router.put('/featured-badge', protect, require('../controllers/dashboard.controller').updateFeaturedBadge);
