...
| **TD-002** | P1 | Backend | `server/middleware/mongoSanitize.js` | Express 5 query/params getter property redefinition was hardened to support writable/configurable properties, allowing downstream validation middlewares to safely mutate or reassign query properties while preserving NoSQL injection protection. | Resolved | August 9, 2026 |
